...
// const { default: nodeify } = require('razorpay/dist/utils/nodeify');
// const {instance} = require('../config/razorpay');
...
//     const Amount = course.price * 100; //amount in paise
//     const currency = "INR";
//     const options = {
//         amount: Amount,
//         currency,
...
//             //enroll course in user's profile
//             const enrolledStudent = await User.findByIdAndUpdate(userId,
//                 {$push: {Courses: courseId}},
//                 {new: true}).exec();
            
//             console.log("Course added to user's profile successfully");

//             //send confirmation email to user
//             const emailResponse = await mailSender(
//                 enrolledStudent.Email,
//                 "Course Enrollment Successful",
//                 `You have been successfully enrolled in the course: ${enrolledCourse.courseName}`
//             );
//             console.log("Enrollment confirmation email sent:",emailResponse);
//         }
//         catch(err){
//             console.error("Error in enrolling user to course",err);
//             return res.status(500).json({
//                 success:false,
//                 message:"Error in enrolling user to course",
//                 err:err.message
//             });
//         }
//     }else{
